...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <a class="navbar-brand" href="Pacientes.php">
        <img src="Logo-VidadePaz.jpeg" width="20%" height="20%" class="d-inline-block align-center" alt="">
        Casa de Reposo Vida de Paz - Módulo Pacientes
    </a>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="RegistroPacientes.php">Registrar Pacientes </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="ListadoPacientes.php">Ver lista de Pacientes</a>
            </li>
